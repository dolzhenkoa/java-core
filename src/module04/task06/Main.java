...
import module04.task04.BankSystem;
import module04.task04.BankSystemImpl;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		bankSystem.fundUser(user2, 3500);
		bankSystem.transferMoney(user3, user4, 2000);
